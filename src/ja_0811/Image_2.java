...
public class Image_2 extends Frame implements ActionListener{
   ...
   public Image_2(String title) {
      ...
      txt = new TextField("src/images/다운로드.jpg", 20);
   ...
   class XCanvas_3 extends Canvas{
      ...
      public void paint(Graphics g) {
         ...
         case 축소:
            ...
            break;
         case 좌우:
            g.drawImage(img, img.getWidth(this), 0, 0,
                                    img.getHeight(this), 0, 0,
                                       img.getWidth(this),
                                       img.getHeight(this), this);
            break;
...
//   
//           img - 렌더링 되는 지정 이미지. img가 null인 경우에는 아무것도 실시하지 않는다.
//           x - x좌표
//           y - y좌표
//           width - 구형의 폭
//           heigth - 구형의 높이
//           obserber - 이미지가 또한 변환되는 것이 통지되는 객체
